...
<div class="white:bg-gray-800 py-12 " >
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg" >
        <div class="bg-blue overflow-hidden shadow-sm sm:rounded-lg ">
            <div class="p-6 bg-blue border-b border-blue-200 dark:bg-blue-800">
                <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex items-baseline justify-between border-b border-gray200 pt-2 pb-6">
                        <h1 class="text-4xl font-bold tracking-tight text-gray900 dark:text-black-100">Destinasi Wisata Banjar Tegeha</h1>
                            ...
                            <div date-rangepicker class="flex items-center">
                                <div class="relative">
                                    ...
                                    <input name="start" type="text"
                                        class="bg-gray-50 border bordergray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block wfull pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:textblack dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div class="relative">
                                    ...
                                    <input name="end" type="text"
                                        class="bg-gray-50 border border-gray300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block wfull pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:textblack dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <section>
                        ...
                        <div class="md:flex font-sans pt-8">
                            ...
                            <form class="p-6">
                                <div class="flex flex-wrap">
                                    <h1 class="flex-auto font-medium text-slate-900 dark:text-black">
                                ...
                                <div class="flex items-baseline mt-4 mb-6 pb-6 border-b borders-late-200 dark:text-black">
                                ...
                                <div class="flex space-x-4 mb-5 text-sm font-medium">
                                    <div class="flex-auto flex space-x-4">
                                        <button class="h-10 px-6 font-semibold rounded-full bg-violet-600 text-black hover:bg-violet-800"
                                            type="submit">
                                            Book Now
                                        </button>
                                        <button data-bs-toggle="modal" data-bstarget="#exampleModalLg"
                                            class="h-10 px-6 font-semibold rounded-full border border-slate200 text-slate-900 dark:text-black hover:bg-violet-800 hover:border-none hover:text-black"
                                            type="button">
                                            Check Availability
                                        </button>
                                    </div>
                                ...
                                <p class="text-sm text-slate-500 white:text-black-300" >
                        ...
                        <div class="md:flex font-sans pt-8">
                            ...
                            <form class="p-6">
                                ...
                                <div class="flex items-baseline mt-4 mb-6 pb-6 border-b border-slate-200 dark:text-black">
                                ...
                                <div class="flex space-x-4 mb-5 text-sm font-medium">
                                    <div class="flex-auto flex space-x-4">
                                        <button class="h-10 px-6 font-semibold rounded-full bg-slate-600 text-black hover:bg-slate-900"
                                            type="submit">
                                            Book Now
                                        </button>
                                        <button data-bs-toggle="modal" data-bstarget="#exampleModalLg"
                                ...
                                <p class="text-sm text-slate-500 dark:text-black-300">
                        ...
                        <div class=" font-sans pt-8 text-center">
                            <a href="#"
                                class="inline-flex items-center py-2 px-4 text-sm fontmedium text-gray-500 bg-black rounded-lg border border-gray-300 hover:bg-violet-600 hover:text-black dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray700 dark:hover:text-black">
                                Sebelumnya

                            </a>
                            <!-- Next Button -->
                            <a href="#"
                                class="inline-flex items-center py-2 px-4 ml-3 text-sm fontmedium text-gray-500 bg-black rounded-lg border border-gray-300 hover:bg-violet-600 hover:text-black dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray700 dark:hover:text-black">
                                Selanjutnya
                            </a>
                        </div>
                    </section>
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-xhidden overflow-y-auto"
        ...
        <div class="modal-dialog modal-lg relative w-auto pointer-events-none">
            <div
                class="modal-content border-none shadow-lg relative flex flex-col wfull pointer-events-auto bg-black bg-clip-padding rounded-md outline-none text-current">
                <?php echo $__env->make('frontpage.calendar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\Laravel\app_name\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>