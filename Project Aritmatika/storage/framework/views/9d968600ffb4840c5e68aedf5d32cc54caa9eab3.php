        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex items-baseline justify-between border-b border-gray200 pt-2 pb-6">
                    <h1 class="text-4xl font-bold tracking-tight text-gray900">Pemesanan Paket</h1>
                </div>
                <section>
                    <div class="flex justify-around md:justify-around py-5">
                                    ...
                                    <form class="pt-6">
                                        <div class="flex flex-wrap">
                                            ...
                                            <div class="flex space-x-4 mt-1 text-sm font-medium">
                                                <button
                                                    class="flex-none flex items-center justify-center w-9 h9 ml-2 rounded-full text-violet-600 bg-violet-50"
                                        ...
                                        <p class="text-sm text-slate-500">
                                            1 Entry Ticket and Free Shampoo at Bath Area
                                        </p>
                            ...
                            <div class="font-sans pt-8 border-slate-200">
                                <div class="max-w-sm">
                                    ...
                                    <form class="pt-6">
                                        ...
                                        <p class="text-sm text-slate-500">
                                        5 Entry Ticket, Free shampoo, And Free Drinks at canteen
                                        </p>
                                        <div class="w-full flex-none order-1 text-3xl fontbold text-violet-600">
                                        Rp. 100.000
                                        </div>
                                ...
                                <div class="max-w-sm">
                                    <div class="md:shrink-0">
                                        <img src="https://i.pinimg.com/564x/1e/f6/3b/1ef63b79d76006b03ff0e3085d6e8bc2.jpg"
                                            alt="" class="md:h-80 md:w-56 inset-0 object-cover rounded-lg"loading="lazy" />
                                    </div>
                                    <form class="pt-6">
                                        <div class="flex flex-wrap">
                                            <h1 class="flex font-medium text-slate-900">
                                        ...
                                        <p class="text-sm text-slate-500">
                                        10 Entry Ticket, Fotographer, All the rest package benefit, and Free meal at canteen
                                        </p>
                                        <div class="w-full flex-none order-1 text-3xl fontbold text-violet-600">
                                            RP.250.000
                                        </div>
                        ...
                        <div class="w-fit">
                            ...
                            <div class="flex justify-between mt-5 mb-5">
                                <span class="font-semibold text-sm uppercase">Premium Package</span>
                                <span class="font-semibold text-sm">Rp 250.000</span>
                            </div>
                            <div class="flex justify-between mb-5">
                                <span class="font-semibold text-sm uppercase">Family Package</span>
                                <span class="font-semibold text-sm">Rp 150.000</span>
                            </div>
                            <div class="pt-10">
                            ...
                            <button
                                class="bg-red-500 hover:bg-red-600 px-5 py-2 mt-2 text-sm text-white uppercase">Apply</button>
...
</div><?php /**PATH C:\Laravel\Laravel Wisata\resources\views/frontpage/cart.blade.php ENDPATH**/ ?>